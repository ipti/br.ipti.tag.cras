...
import { CreateFamilyHappyChildContext } from "../../../context/HappyChild/FamilyHC/CreateFamilyHCContext";

const CreateFamilyHappyChildScreen = () => {

    const { setActiveStep, activeStep } = useContext(CreateFamilyHappyChildContext);
...
export default CreateFamilyHappyChildScreen;